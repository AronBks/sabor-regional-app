...
// Importar las imágenes locales directamente
const IMAGENES_RECETAS = {
  // REGIÓN ANDINA
  1: require('./assets/images/recetas/andina/arepa-maiz-blanco.jpg'),
  2: require('./assets/images/recetas/andina/papa-rellena.jpg'),
  3: require('./assets/images/recetas/andina/empada-pollo.jpg'),

  // REGIÓN COSTA
  4: require('./assets/images/recetas/costa/ceviche-pescado.jpg'),
  5: require('./assets/images/recetas/costa/arroz-mariscos.webp'),
  6: require('./assets/images/recetas/costa/pescado-frito.jpg'),

  // REGIÓN AMAZÓNICA
  7: require('./assets/images/recetas/amazonica/tacacho-cecina.jpg'),
  8: require('./assets/images/recetas/amazonica/juane-pollo.jpg'),
  9: require('./assets/images/recetas/amazonica/patarashca.jpg'),
  10: require('./assets/images/recetas/amazonica/inchicapi.jpg'),
  11: require('./assets/images/recetas/amazonica/rocoto-relleno.jpg'),

  // REGIÓN PAMPA
  12: require('./assets/images/recetas/pampa/asado-tira.jpg'),
  13: require('./assets/images/recetas/pampa/empada-carne.jpg'),
  14: require('./assets/images/recetas/pampa/locro-zapallo.jpg'),

  // REGIÓN ALTIPLANO
  15: require('./assets/images/recetas/altiplano/chairo-paceño.jpg'),
  16: require('./assets/images/recetas/altiplano/charquekan.jpg'),
  17: require('./assets/images/recetas/altiplano/jaka-lawa.jpg'),
};
  ...
  const renderRecipeDetail = (recipe: any) => {
    ...
    return (
      <ScrollView style={styles.recipeDetailContainer}>
        ...
        {/* Imagen de la receta */}
        <Image source={{ uri: recipe.img }} style={styles.detailImage} />
            ...
            {RECETAS.filter(r => r.destacado && (region === 'Todas' || r.region === region)).map(r => (
              <TouchableOpacity key={r.id} onPress={() => { setSelectedRecipe(r); setActiveTab('ingredientes'); }}>
                <View style={[styles.recipeCard, { borderLeftColor: getColorRegion(r.region), borderLeftWidth: 4 }]}>
                  <Image source={{ uri: r.img }} style={styles.recipeImage} />
